...
while True:
    ...
    print('15. mapa pokazujaca jednego klienta')
    print('16. mapa wszystkich klientow')
    ...
    print('25. mapa pokazujaca jednego pracownika')
    print('26. mapa wszystkich pracownikow')
